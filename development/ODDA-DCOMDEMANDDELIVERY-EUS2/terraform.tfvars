...
solution_abbreviation      = "DCOMDEMANDDELIVERY"
resource_abbreviation      = "DCOMODD"
...
environment_config = {
  solution_settings = {
    ...
    solution_service_principal_name     = "Stage - DNA-DEV-MW-DEMAND-DCOMODD-EUS2"
    cicd_service_principal_name         = "Stage - DNA-DEV-MW-DEMAND-DCOMODD-CICD-EUS2"
  }

  app_services = {
    solution_webapp = {
      docker_image_name = "DCOMODD:development"
    ...
    interactive_clusters = {
      "solution_cluster" = {
        ...
        spark_conf = {
          ...
          "fs.azure.account.oauth2.client.secret.demandstageeus2devsa.dfs.core.windows.net" : "{{secrets/DCOMDEMANDDELIVERY-SECRETSCOPE/sp-client-secret}}"
          "fs.azure.account.oauth2.client.id.demandstageeus2devsa.dfs.core.windows.net" : "{{secrets/DCOMDEMANDDELIVERY-SECRETSCOPE/sp-client-id}}"
          ...
          "fs.azure.account.oauth2.client.secret.demandlakeeus2devsa.dfs.core.windows.net" : "{{secrets/DCOMDEMANDDELIVERY-SECRETSCOPE/sp-client-secret}}"
          ...
          "fs.azure.account.oauth2.client.id.demandlakeeus2devsa.dfs.core.windows.net" : "{{secrets/DCOMDEMANDDELIVERY-SECRETSCOPE/sp-client-id}}"
          ...
          "fs.azure.account.oauth2.client.secret.demandvaulteus2devsa.dfs.core.windows.net" : "{secrets/DCOMDEMANDDELIVERY-SECRETSCOPE/sp-client-secret}}"
          "fs.azure.account.oauth2.client.id.demandvaulteus2devsa.dfs.core.windows.net" : "{{secrets/DCOMDEMANDDELIVERY-SECRETSCOPE/sp-client-id}}"
          ...
          "fs.azure.account.oauth2.client.secret.marsanalyticsprodadls.dfs.core.windows.net" : "{{secrets/DCOMDEMANDDELIVERY-SECRETSCOPE/aoh-spsecret}}"
          ...
          "fs.azure.account.oauth2.client.id.marsanalyticsprodadls.dfs.core.windows.net" : "{{secrets/DCOMDEMANDDELIVERY-SECRETSCOPE/aoh-spclientid}}"
